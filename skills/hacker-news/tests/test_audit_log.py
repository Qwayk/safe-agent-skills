...
from hacker_news_api_tool.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    "tool": "hacker-news-api-tool",
                    "version": "0.0.0",
                    "command": "hacker-news-api-tool maxitem get",
            ...
            self.assertEqual(obj["tool"], "hacker-news-api-tool")
