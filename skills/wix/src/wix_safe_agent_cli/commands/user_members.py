...
COMMAND_FAMILY = "user-members"
BASE_PATH = "/members/v1/user-members"
...
def cmd_user_members_query(args, ctx) -> int:
    ...
    try:
        ...
        out = {
            ...
            "method": method,
            "auth_mode": auth["mode"],
            "request": {"method": "POST", "path": f"{BASE_PATH}/query", "body": body},
            "response": response,
        }
