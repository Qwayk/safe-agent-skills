...
COMMAND_FAMILY = "member-custom-field-suggestions"
BASE_PATH = "/members/v1/custom-field-suggestions"
...
def cmd_member_custom_field_suggestions_query(args, ctx) -> int:
...
def cmd_member_custom_field_suggestions_list(args, ctx) -> int:
