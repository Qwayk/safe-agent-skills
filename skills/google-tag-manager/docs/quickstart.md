...
This page helps you get one useful Google Tag Manager result quickly, without turning the quickstart into a full command manual.

If you are still deciding what to ask, start with [What you can do with Google Tag Manager](use_cases.md). If setup is not done yet, read [Connect your Google Tag Manager account](onboarding.md).
