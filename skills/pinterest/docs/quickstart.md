...
Start with a small Pinterest read: checking boards, pins, catalogs, ads, and account structure before you publish or change campaigns.

Need more ideas? See [What you can do with Pinterest](use_cases.md). Need setup help? See [Connect your Pinterest account](onboarding.md).
...
Ask for a reviewed plan before pin, board, catalog, ad, report-job, account, or link changes.
