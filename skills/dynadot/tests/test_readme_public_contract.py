...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# Dynadot\n"))
        self.assertNotIn("## Simplicity lock", text)
        self.assertNotIn("# dynadot-api-tool", text)
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all Dynadot docs](docs/README.md)", text)
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn("[What you can do with Dynadot](docs/use_cases.md)", text)
        self.assertIn("[Connect your Dynadot account](docs/onboarding.md)", text)
