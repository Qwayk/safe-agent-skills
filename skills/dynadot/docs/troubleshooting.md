...
- **“Please use your account firstly.”** → future transfer apply may need the sender Dynadot account enabled for transfer in the control panel. Current write apply requires explicit no-snapshot approval before that provider call.
