...
from callrail_safe_agent_cli.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    ...
                    "version": "0.0.0",
                    "command": "qwayk-callrail-safe-agent-cli auth check",
                    "apply": False,
                    "yes": False,
                    "env_fingerprint": "http://callrail.invalid",
                }
            )
            audit.write(
                "test.event",
            ...
            self.assertEqual(obj["tool"], "qwayk-callrail-safe-agent-cli")
