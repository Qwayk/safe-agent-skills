...
from jobber_safe_agent_cli.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    ...
                    "version": "0.0.0",
                    "command": "qwayk-jobber-safe-agent-cli schema summary",
                    "apply": False,
                    "yes": False,
            ...
            self.assertEqual(obj["tool"], "qwayk-jobber-safe-agent-cli")
