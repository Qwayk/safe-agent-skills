...
def read_stored_access_token(*, env_file: str, fallback_token: str | None) -> str | None:
    """
    Return OAuth access token from stored token file first, else fallback to env config.
    """
