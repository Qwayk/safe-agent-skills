...
Start with a small Plausible read: checking privacy-friendly traffic, conversions, goals, and site trends before you change analytics setup.

Need more ideas? See [What you can do with Plausible](use_cases.md). Need setup help? See [Connect your Plausible account](onboarding.md).
...
Ask for a reviewed plan before site, goal, shared-link, custom-property, or settings changes.
...
- For setup details, read [Connect your Plausible account](onboarding.md).
