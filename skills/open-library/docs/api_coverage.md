...
Open Library coverage shows exactly what this skill can do with public books, authors, editions, subjects, and ISBN data. Start here when an ask sounds possible but you need to know whether it is already shipped, read-only, plan-first, gated, excluded, or outside the tool.
...
A good first coverage check is: "Check whether this skill can search books, open one work and edition, and show which Open Library endpoints are out of scope."
