...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# Sovrn\n"))
        self.assertNotIn("## Simplicity lock", text)
        self.assertNotIn("# sovrn-safe-cli", text)
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all Sovrn docs](docs/README.md)", text)
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn("[What you can do with Sovrn](docs/use_cases.md)", text)
        self.assertIn("[Connect your Sovrn account](docs/onboarding.md)", text)
