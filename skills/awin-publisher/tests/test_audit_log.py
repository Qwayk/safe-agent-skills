...
from awin_publisher_safe_agent_cli.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    "tool": "awin-publisher-safe-cli",
                    "version": "0.0.0",
                    "command": "awin-publisher-safe-cli auth check",
                    "apply": False,
                    "yes": False,
            ...
            self.assertEqual(obj["tool"], "awin-publisher-safe-cli")
