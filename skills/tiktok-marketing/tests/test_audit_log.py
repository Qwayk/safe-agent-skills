...
from tiktok_marketing_safe_agent_cli.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    ...
                    "version": "0.0.0",
                    "command": "tiktok-marketing-api-tool auth token status",
                    "apply": False,
                    "yes": False,
            ...
            self.assertEqual(obj["tool"], "tiktok-marketing-api-tool")
