...
from amazon_creators_api_tool.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    ...
                    "version": "0.0.0",
                "command": "amazon-creators-api-tool auth check",
                    "apply": False,
                    "yes": False,
            ...
            self.assertEqual(obj["tool"], "amazon-creators-api-tool")
