# Amazon Creators docs

Amazon Creators is easiest to use when you start with the real job, then check setup, safety, and proof before asking an agent to do more. These docs explain how to check creator lists, storefront details, and creator-campaign reporting, what access is needed, and where the tool stops before risky changes.
...
## Start with the work
- [What you can do with Amazon Creators](use_cases.md) - real jobs to hand to an agent for Amazon Creators
- [Quickstart](quickstart.md) - the shortest path to one useful first result
- [Connect your Amazon Creators account](onboarding.md) - what must be connected or confirmed before the first run
