...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# OpenAI\n"))
        self.assertNotIn("## Simplicity lock", text)
        self.assertNotIn("# openai-api-tool", text)
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all OpenAI docs](docs/README.md)", text)
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn("[What you can do with OpenAI](docs/use_cases.md)", text)
        self.assertIn("[Connect your OpenAI access](docs/onboarding.md)", text)
    ...
    def test_quickstart_opens_with_human_links(self) -> None:
        ...
        self.assertIn("[Connect your OpenAI access](onboarding.md)", text)
