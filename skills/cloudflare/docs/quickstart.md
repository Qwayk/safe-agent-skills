...
This page helps you get one useful Cloudflare result quickly, without turning the quickstart into a full command manual.

If you are still deciding what to ask, start with [What you can do with Cloudflare](use_cases.md). If setup is not done yet, read [Connect your account](onboarding.md).
