...
Start with a small Google Search Console read: checking sites, inspection data, sitemaps, and search performance before you request changes.

Need more ideas? See [What you can do with Google Search Console](use_cases.md). Need setup help? See [Connect your Google Search Console account](onboarding.md).
...
Ask for a reviewed plan before sitemap submissions, URL inspection actions, permission changes, or any write-like request.
