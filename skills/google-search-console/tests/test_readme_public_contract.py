...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# Google Search Console\n"))
        self.assertNotIn("## Simplicity lock", text)
        self.assertNotIn("# gsc-api-tool", text)
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn(
            "[What you can do with Google Search Console](docs/use_cases.md)",
            text,
        )
        self.assertIn(
            "[Connect your Google Search Console account](docs/onboarding.md)",
            text,
        )
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all Google Search Console docs](docs/README.md)", text)
    ...
    def test_quickstart_opens_with_human_links(self) -> None:
        ...
        self.assertIn(
            "[Connect your Google Search Console account](onboarding.md)",
            text,
        )
