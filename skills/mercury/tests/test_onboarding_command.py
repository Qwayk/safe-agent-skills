    ...
    def test_onboarding_creates_env_from_example(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            with open(example_path, "w", encoding="utf-8") as f:
                f.write("MERCURY_API_BASE_URL=https://api.mercury.com/api/v1\n")
                f.write("MERCURY_API_TOKEN=secret-token:paste_your_token_here\n")
                f.write("MERCURY_AUTH_SCHEME=bearer\n")
