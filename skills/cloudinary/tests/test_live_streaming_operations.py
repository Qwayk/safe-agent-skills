...
class TestLiveStreamingOperations(unittest.TestCase):
    def test_live_streaming_area_has_a_runnable_explicit_command(self) -> None:
        spec = spec_for_area("live_streaming")
