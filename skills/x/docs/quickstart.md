...
Start with a small X read: checking account access, mentions, posts, DMs, and safe read options before you send or change anything.

Need more ideas? See [What you can do with X](use_cases.md). Need setup help? See [Connect your X account](onboarding.md).
...
Ask for a reviewed plan before posts, replies, DMs, follows, deletes, auth changes, or any action that changes the live X account.
...
- For setup details, read [Connect your X account](onboarding.md).
