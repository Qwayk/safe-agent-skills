...
X is easiest to use when you start with the real job, then check setup, safety, and proof before asking an agent to do more. These docs explain how to read posts, users, timelines, search results, and account-accessible social data, what access is needed, and where the tool stops before risky changes.
...
## Start with the work
- [What you can do with X](use_cases.md) - real jobs to hand to an agent for X
- [Quickstart](quickstart.md) - the shortest path to one useful first result
- [Connect your X account](onboarding.md) - what must be connected or confirmed before the first run
