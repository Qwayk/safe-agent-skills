...
Instagram is easiest to use when you start with the real job, then check setup, safety, and proof before asking an agent to do more. These docs explain how to read account, media, comments, insights, and profile data the connected app can access, what access is needed, and where the tool stops before risky changes.
...
## Start with the work
- [What you can do with Instagram](use_cases.md) - real jobs to hand to an agent for Instagram
- [Quickstart](quickstart.md) - the shortest path to one useful first result
- [Connect your Instagram account](onboarding.md) - what must be connected or confirmed before the first run
