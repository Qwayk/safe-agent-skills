...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# Instagram\n"))
        self.assertNotIn("# instagram-api-tool", text)
        self.assertNotIn("## For non-technical users: Start here (no coding)", text)
        self.assertIn("Instagram is where professional-account", text)
        for stale_phrase in [
            "Use this skill when",
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all Instagram docs](docs/README.md)", text)
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn("[What you can do with Instagram](docs/use_cases.md)", text)
        self.assertIn("[Connect your Instagram access](docs/onboarding.md)", text)
    ...
    def test_quickstart_opens_with_human_links(self) -> None:
        ...
        self.assertIn("[Connect your Instagram access](onboarding.md)", text)
    ...
    def test_use_cases_stay_specific_and_human(self) -> None:
        ...
        self.assertIn("Instagram professional-account work", text)
