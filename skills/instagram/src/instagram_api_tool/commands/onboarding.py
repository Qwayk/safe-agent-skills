...
def cmd_onboarding(args: object, ctx: dict) -> int:
    ...
    steps = [
        ...
        "  - INSTAGRAM_REDIRECT_URI=<your exact OAuth redirect URI>",
        "Start the Instagram Login consent flow and exchange the returned code for an access token.",
        "Store the access token in INSTAGRAM_ACCESS_TOKEN or under .state/token.json.",
        "Run: instagram-api-tool --output json auth check",
    ]
    ...
    payload = {
        ...
        "onboarding": {
            ...
            "missing": missing,
            "next_command": "instagram-api-tool --output json auth check",
            "steps": steps,
        },
    }
    ...
    if str(getattr(args, "output", "json")) == "json":
        ...
        print("")
        print("Next: instagram-api-tool --output json auth check")
    return 0
