...
BEFORE_STATE_REFUSAL_REASON = (
    "Refused: this Instagram write has no reliable before-state snapshot. "
...
def before_state_refusal_verification_plan() -> dict[str, Any]:
    return {
        ...
        "steps": [
            "Record the Instagram provider or token response in the receipt.",
            "Record any local token file written by the flow.",
