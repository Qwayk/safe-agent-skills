...
- Precheck hygiene for standalone export: empty `FREEPIK_API_KEY` in `.env.example`, add `.env`, harden `.gitignore`, and remove monorepo-specific install paths from docs.
