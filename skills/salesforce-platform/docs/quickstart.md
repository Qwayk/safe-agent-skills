...
Start with a small Salesforce Platform read: checking org resources, limits, objects, and records before you change CRM data.

Need more ideas? See [What you can do with Salesforce Platform](use_cases.md). Need setup help? See [Connect your Salesforce account](onboarding.md).
...
Ask for a reviewed plan before object, record, metadata, permission, job, or org setting changes.
...
- For setup details, read [Connect your Salesforce account](onboarding.md).
