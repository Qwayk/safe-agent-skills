...
Ghost is easiest to use when you start with the real job, then check setup, safety, and proof before asking an agent to do more. These docs explain how to review posts, pages, members, tags, and publication data, what access is needed, and where the tool stops before risky changes.
...
## Start with the work
- [What you can do with Ghost](use_cases.md) - real jobs to hand to an agent for Ghost
- [Quickstart](quickstart.md) - the shortest path to one useful first result
- [Connect your Ghost account](onboarding.md) - what must be connected or confirmed before the first run
...
## Extra guides
- [Content and Lexical mode](content_lexical_mode.md) - Ghost content-mode behavior and limits
- [Logging and auditing](logging_and_auditing.md) - how local logs and audit trails should be read
