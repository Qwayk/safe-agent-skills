...
class TestRunArtifacts(unittest.TestCase):
    def test_make_write_plan_creates_run_folder_and_index(self) -> None:
            ...
            with redirect_stdout(buf):
                rc = main(
                    [
                        ...
                        "create-scenario",
                        "--body-json",
                        '{"blueprint":"{\\"flow\\":[]}","teamId":123,"scheduling":"{\\"type\\":\\"indefinitely\\"}"}',
                    ]
                )
                ...
                json.dumps(
                    {
                        ...
                        "operation": {"family": "scenarios", "command": "create-scenario"},
                        "target": {"path_params": {}, "query": {}},
                    }
                ),
                encoding="utf-8",
            )
