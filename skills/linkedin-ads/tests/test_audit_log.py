...
from linkedin_ads_api_tool.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    ...
                    "version": "0.0.0",
                    "command": "linkedin-ads-api-tool ad-campaign-groups batch-get",
                    "apply": False,
                    "yes": False,
            ...
            self.assertEqual(obj["tool"], "linkedin-ads-api-tool")
