...
def build_linkedin_headers(*, token: str | None, linkedin_version: str, restli_protocol_version: str) -> dict[str, str]:
    if not token or not str(token).strip():
        raise ValueError("Missing LinkedIn token in config")
    return {
