...
Start with a small Google Analytics read: checking properties, traffic, events, and reporting data before you change measurement setup.

Need more ideas? See [What you can do with Google Analytics](use_cases.md). Need setup help? See [Connect your Google Analytics access](onboarding.md).
...
Ask for a reviewed plan before property, event, audience, conversion, access, or measurement changes.
