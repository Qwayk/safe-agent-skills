...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# YouTube\n"))
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all YouTube docs](docs/README.md)", text)
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn("[What you can do with YouTube](docs/use_cases.md)", text)
        self.assertIn("[Connect your YouTube account](docs/onboarding.md)", text)
    ...
    def test_opening_rejects_template_voice(self) -> None:
        ...
        banned = [
            ...
            "work with YouTube safely",
            "It is best for work where",
        ]
    ...
    def test_quickstart_opens_with_human_links(self) -> None:
        ...
        self.assertIn("[What you can do with YouTube](use_cases.md)", text)
        self.assertIn("[Connect your YouTube account](onboarding.md)", text)
