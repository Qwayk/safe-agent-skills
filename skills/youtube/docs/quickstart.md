...
Start with a small YouTube read: checking channels, uploads, playlists, captions, and metadata before you upload or edit anything.

Need more ideas? See [What you can do with YouTube](use_cases.md). Need setup help? See [Connect your YouTube account](onboarding.md).
...
Ask for a reviewed plan before uploads, playlist edits, metadata changes, caption changes, deletes, or token changes.
