# BrandSuggestionService (Google Ads API v22)

Command shape:
- `google-ads-api-tool brand-suggestion-service <method-kebab> --in request.json`
...
## Methods
- `suggest-brands` — `BrandSuggestionService.SuggestBrands` (read; unary) — request: `SuggestBrandsRequest` → response: `SuggestBrandsResponse`
