# ConversionValueRuleSetService (Google Ads API v22)

Command shape:
- `google-ads-api-tool conversion-value-rule-set-service <method-kebab> --in request.json`
