# CustomerSkAdNetworkConversionValueSchemaService (Google Ads API v22)

Command shape:
- `google-ads-api-tool customer-sk-ad-network-conversion-value-schema-service <method-kebab> --in request.json`
