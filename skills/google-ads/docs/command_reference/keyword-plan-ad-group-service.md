# KeywordPlanAdGroupService (Google Ads API v22)

Command shape:
- `google-ads-api-tool keyword-plan-ad-group-service <method-kebab> --in request.json`
