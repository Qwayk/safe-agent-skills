# InvoiceService (Google Ads API v22)

Command shape:
- `google-ads-api-tool invoice-service <method-kebab> --in request.json`
...
## Methods
- `list-invoices` — `InvoiceService.ListInvoices` (read; unary) — request: `ListInvoicesRequest` → response: `ListInvoicesResponse`
