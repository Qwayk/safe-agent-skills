...
Google Ads is easiest to use when you start with the real job, then check setup, safety, and proof before asking an agent to do more. These docs explain how to review campaigns, ad groups, keywords, budgets, and account health, what access is needed, and where the tool stops before risky changes.
...
## Start with the work
- [What you can do with Google Ads](use_cases.md) - real jobs to hand to an agent for Google Ads
- [Quickstart](quickstart.md) - the shortest path to one useful first result
- [Connect your Google Ads account](onboarding.md) - what must be connected or confirmed before the first run
...
## Extra guides
- [Media buyer quickstart](media_buyer_quickstart.md) - a Google Ads path for campaign review work
- [Winning ads workbook](winning_ads_workbook.md) - ad review prompts and worksheet-style guidance
- [KPI dictionary](kpi_dictionary.md) - plain-English meanings for the metrics used in reports
- [Agent recipes](agent_recipes.md) - ready workflows an agent can follow
- [Diagnosis reference](diagnosis_reference.md) - how diagnosis findings should be read
