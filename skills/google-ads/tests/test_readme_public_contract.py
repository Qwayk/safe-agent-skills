...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# Google Ads\n"))
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn("[What you can do with Google Ads](docs/use_cases.md)", text)
        self.assertIn("[Connect your Google Ads account](docs/onboarding.md)", text)
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all Google Ads docs](docs/README.md)", text)
        self.assertIn("[Winning ads workbook](docs/winning_ads_workbook.md)", text)
        self.assertIn("[Presets reference](docs/presets_reference.md)", text)
    ...
    def test_quickstart_opens_with_human_links(self) -> None:
        ...
        self.assertIn("[Connect your Google Ads account](onboarding.md)", text)
