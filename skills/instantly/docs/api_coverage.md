...
Instantly coverage shows exactly what this skill can do with campaigns, leads, accounts, inboxes, analytics, and send-related workflows. Start here when an ask sounds possible but you need to know whether it is already shipped, read-only, plan-first, gated, excluded, or outside the tool.
...
A good first coverage check is: "Check whether this skill can inspect campaigns, leads, inboxes, and analytics, then show which send actions are covered."
