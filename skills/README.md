...
Start here if you want app-to-app workflows, automation review, or careful automation changes.
...
| [**Google Cloud Platform**](gcp/README.md)<br><sub>Install slug: <code>gcp</code></sub> | Review Google Cloud projects, access, running resources, cost-sensitive areas, logs, and prepare careful infrastructure changes | Google Cloud account | Reads + careful changes |
| [**Azure**](azure/README.md)<br><sub>Install slug: <code>azure</code></sub> | Review Azure subscriptions, resources, access, cost-sensitive areas, networking, secrets, and prepare careful infrastructure changes | Azure account | Reads + careful changes |
...
| [**GiantPanda**](giantpanda/README.md)<br><sub>Install slug: <code>giantpanda</code></sub> | Review parked-domain traffic and earnings, then prepare reviewed domain-add plans | GiantPanda account | Reads + careful changes |
...
| [**Porkbun**](porkbun/README.md)<br><sub>Install slug: <code>porkbun</code></sub> | Review domains, prices, DNS, SSL, email, marketplace listings, account settings, and webhooks, then prepare careful changes | Porkbun account | Reads + careful changes |
| [**SAV**](sav/README.md)<br><sub>Install slug: <code>sav</code></sub> | Review SAV domains, pricing, and recent sales, then prepare careful domain account changes | SAV account | Reads + careful changes |
| [**NameBright**](namebright/README.md)<br><sub>Install slug: <code>namebright</code></sub> | Review NameBright domains, contacts, DNS, renewals, purchases, and account pushes, then prepare careful changes | NameBright account | Reads + careful changes |
| [**Spaceship**](spaceship/README.md)<br><sub>Install slug: <code>spaceship</code></sub> | Review Spaceship domains, DNS, contacts, transfers, personal nameservers, SellerHub, sold-domain reports, and SafePay, then prepare careful changes | Spaceship account | Reads + careful changes |
