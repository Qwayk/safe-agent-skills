...
from skimlinks_safe_agent_cli.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    ...
                    "version": "0.0.0",
                    "command": "skimlinks-safe-cli merchant verticals list",
                    "apply": False,
                    "yes": False,
                    "env_fingerprint": "skimlinks:123:456",
                }
            )
            audit.write(
                "test.event",
            ...
            self.assertEqual(obj["tool"], "skimlinks-safe-cli")
