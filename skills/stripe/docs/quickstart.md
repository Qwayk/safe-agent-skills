...
Start with a small Stripe read: checking customers, payments, subscriptions, invoices, and account data before you touch money movement.

Need more ideas? See [What you can do with Stripe](use_cases.md). Need setup help? See [Connect your Stripe account](onboarding.md).
...
Ask for a reviewed plan before refunds, payment changes, customer updates, subscription changes, invoice work, webhook changes, or anything involving live money.
...
- For setup details, read [Connect your Stripe account](onboarding.md).
