...
from google_merchant_api_tool.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    ...
                    "version": "0.0.0",
                    "command": "google-merchant-api-tool accounts product-inputs insert --parent accounts/123456 --body-json '{\"channel\":\"ONLINE\",\"contentLanguage\":\"en\",\"offerId\":\"SKU-RED-123\",\"feedLabel\":\"US\"}'",
                    "apply": False,
                    "yes": False,
            ...
            self.assertEqual(obj["tool"], "google-merchant-api-tool")
