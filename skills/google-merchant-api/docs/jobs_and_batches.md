...
If you need batch-style work, build it around the shipped explicit commands from `docs/command_reference.md` and keep `docs/api_coverage.md` as the main reference for what is actually supported.
