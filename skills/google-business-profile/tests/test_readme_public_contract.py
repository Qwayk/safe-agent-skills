...
class TestReadmePublicContract(unittest.TestCase):
    def test_public_readme_opening_stays_user_facing(self) -> None:
        ...
        self.assertTrue(text.startswith("# Google Business Profile\n"))
        self.assertNotIn("## Shipped command surface", text)
        self.assertNotIn("# Google Business Profile Safe CLI", text)
        self.assertIn("Google Business Profile is where local customers", text)
        for stale_phrase in [
            "Use this skill when",
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn(
            "[What you can do with Google Business Profile](docs/use_cases.md)",
            text,
        )
        self.assertIn(
            "[Connect your Google Business Profile access](docs/onboarding.md)",
            text,
        )
    ...
    def test_quickstart_opens_with_human_links(self) -> None:
        ...
        self.assertIn(
            "[Connect your Google Business Profile access](onboarding.md)",
            text,
        )
    ...
    def test_use_cases_stay_specific_and_human(self) -> None:
        ...
        self.assertIn("Google Business Profile work is usually about keeping real-world", text)
