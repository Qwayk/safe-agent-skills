...
This page helps you get one useful Microsoft Ads result quickly, without turning the quickstart into a full command manual.

If you are still deciding what to ask, start with [What you can do with Microsoft Ads](use_cases.md). If setup is not done yet, read [Connect your Microsoft Ads account](onboarding.md).
...
msads-api-tool --apply --yes --plan-in plan.json campaign-management update-campaigns --request-json request.json
```
