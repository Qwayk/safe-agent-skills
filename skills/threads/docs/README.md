...
Threads is easiest to use when you start with the real job, then check setup, safety, and proof before asking an agent to do more. These docs explain how to read profiles, posts, replies, and account media the connected app can access, what access is needed, and where the tool stops before risky changes.
...
## Start with the work
- [What you can do with Threads](use_cases.md) - real jobs to hand to an agent for Threads
- [Quickstart](quickstart.md) - the shortest path to one useful first result
- [Connect your Threads account](onboarding.md) - what must be connected or confirmed before the first run
