...
class TestReadmePublicContract(unittest.TestCase):
    ...
    def test_start_here_section_stays_human_facing(self) -> None:
        ...
        self.assertIn("[What you can do with Threads](docs/use_cases.md)", text)
        self.assertIn("[Connect your Threads account](docs/onboarding.md)", text)
    ...
    def test_helpful_docs_stay_human_facing(self) -> None:
        ...
        self.assertIn("[Browse all Threads docs](docs/README.md)", text)
    ...
    def test_quickstart_opens_with_human_links(self) -> None:
        ...
        self.assertIn("[What you can do with Threads](use_cases.md)", text)
