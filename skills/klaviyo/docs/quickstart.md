...
Start with a small Klaviyo read: checking lists, segments, profiles, forms, campaigns, and flows before you change marketing data.

Need more ideas? See [What you can do with Klaviyo](use_cases.md). Need setup help? See [Connect your Klaviyo account](onboarding.md).
...
Ask for a reviewed plan before profile, list, segment, form, campaign, flow, event, or suppression changes.
