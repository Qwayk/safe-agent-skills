...
Start with a small Shopify Admin read: checking store details, products, orders, customers, and content gaps before you touch the shop.

Need more ideas? See [What you can do with Shopify Admin](use_cases.md). Need setup help? See [Connect your Shopify Admin account](onboarding.md).
...
Ask for a reviewed plan before product, order, customer, inventory, discount, theme, metafield, or store setting changes.
...
- For setup details, read [Connect your Shopify Admin account](onboarding.md).
