...
from zapier_safe_agent_cli.audit_log import AuditLogger
...
class TestAuditLog(unittest.TestCase):
    def test_audit_log_includes_context_and_redacts(self) -> None:
        with tempfile.TemporaryDirectory() as d:
            ...
            audit.bind_context(
                {
                    "tool": "qwayk-zapier-safe-agent-cli",
                    "version": "0.1.0",
                    "command": "qwayk-zapier-safe-agent-cli auth check",
                    "apply": False,
                    "yes": False,
                    "env_fingerprint": "https://api.zapier.com",
                }
            )
            audit.write(
                "test.event",
            ...
            self.assertEqual(obj["tool"], "qwayk-zapier-safe-agent-cli")
